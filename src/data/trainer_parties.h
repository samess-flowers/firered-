...
static const struct TrainerMonItemDefaultMoves sParty_SailorPhillip[] = {
    {
        .iv = 0,
        .lvl = 20,
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalCeruleanSquirtle[] = {
    ...
    },
    {
        ...
        .lvl = 18,
        .species = SPECIES_WARTORTLE,
        .moves = {MOVE_TACKLE, MOVE_BITE, MOVE_WITHDRAW, MOVE_WATER_GUN},
    },
};
...
static const struct TrainerMonItemDefaultMoves sParty_TeamRocketGrunt6[] = {
    {
        .iv = 0,
        .lvl = 17,
